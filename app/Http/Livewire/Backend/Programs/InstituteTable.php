 ...
 * Class RolesTable.
 */
class InstituteTable extends DataTableComponent
{
    /**
     * @return Builder
     */
    ...
    {
        return Institute::query()->when($this->getFilter('search'), fn ($query, $term) => $query->where('id', 'like', '%' . $term . '%')
    ...
    {
        return 'backend.programs.institutes.includes.row';
    }
}
