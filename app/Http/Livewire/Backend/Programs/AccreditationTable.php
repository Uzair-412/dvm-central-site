 ...
 * Class RolesTable.
 */
class AccreditationTable extends DataTableComponent
{
    /**
     * @return Builder
     */
    ...
    {
        return AccreditationStatus::query()->when($this->getFilter('search'), fn ($query, $term) => $query->where('id', 'like', '%' . $term . '%')
    ...
    {
        return 'backend.programs.accreditations.includes.row';
    }
}