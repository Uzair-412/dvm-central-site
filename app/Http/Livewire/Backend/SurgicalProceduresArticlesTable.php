 ...
 * Class RolesTable.
 */
class SurgicalProceduresArticlesTable extends DataTableComponent
{
    /**
     * @return Builder
     */
    ...
    {
        return SurgicalProceduresArticle::query()->when($this->getFilter('search'), fn ($query, $term) => $query->where('id', 'like', '%'.$term.'%')
    ...
    {
        return 'backend.sp-posts.includes.row';
    }
}
