...
class RegisterController
{
    ...
    public function register(Request $request)
    {
        try {
            ...
            if ($validator->fails()) {
                return response()->json(['success' => false, 'error' => $validator->messages(), 'msg' => 'email_exists'], 200);
            }
            ...
            if ($request->confirm_password == $request->password) {
                ...
                return response()->json(
                    ['success' => false, 'error' =>'Password does not matched with confirmed password',],200);
            }
        } catch (\Throwable $th) {
            return response()->json(
                ['success' => false, 'error' =>$th->getMessage(),],200);
        }
    }
