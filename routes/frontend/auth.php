...
use App\Domains\Auth\Http\Controllers\Frontend\Auth\ConfirmAccountController;
...
use App\Http\Livewire\Frontend\TwoFactorAuthentication;
...
Route::group(['as' => 'auth.'], function () {
    ...
    Route::get('account/verified', [ConfirmAccountController::class, 'verified'])->name('account.verified');
                ...
                Route::group(['prefix' => 'account/2fa', 'as' => 'account.2fa.'], function () {
                    Route::group(['middleware' => '2fa:disabled'], function () {
                        Route::get('enable', [TwoFactorAuthenticationController::class, 'create'])
                            ->name('create');
                        Route::post('enable', [TwoFactorAuthentication::class, 'validateCode'])
                            ->name('validateCode')
