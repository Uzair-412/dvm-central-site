...
@section('content')
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url('/up_data/register.jpg');">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            <div class="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style="background-image: url('/up_data/register.jpg');">
                <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
            <div class="w-full py-6 z-20">
                ...
                <p class="text-gray-100">
                    Create your account as an attendee
                </p>
                <form action="{{route('frontend.events.attendees.registration', $event->slug)}}" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    @csrf
                    <div class="pb-2 pt-4 flex">
                        <div class="w-1/2 pr-2">
                            <input type="text" name="first_name" id="first_name" placeholder="First Name" class="block w-full p-4 text-lg rounded-sm bg-black" autocomplete="first_name">
                        </div>
                        <div class="w-1/2">
                            <input type="text" name="last_name" id="last_name" placeholder="Last Name" class="block w-full p-4 text-lg rounded-sm bg-black" autocomplete="last_name">
                        </div>
                    </div>
                    <div class="pb-2 pt-4">
                        <input type="email" name="email" id="email" placeholder="Email" class="block w-full p-4 text-lg rounded-sm bg-black" autocomplete="email">
                    </div>
                    <div class="pb-2 pt-4">
                        <input class="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password" id="password" placeholder="Password" autocomplete="password">
                    </div>
                    <div class="pb-2 pt-4">
                        <input class="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirmation Password" autocomplete="password_confirmation">
                    </div>
