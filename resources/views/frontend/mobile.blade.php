...
<html lang="en">
	<head>
      <meta charset="UTF-8" />
		...
		<title>DVM Central - Market Place for Vetenerians and Distributors</title>
		...
		<link rel="stylesheet" href="/splash/assets/css/swiper.css?v=2" />
		...
		<link rel="stylesheet" href="/splash/assets/css/style.css?v=3" />
	</head>

	<body class="app-eight-home mobile-v" data-spy="scroll" data-target=".navigation-eight" data-offset="100">
		<!-- preloader - start -->
						...
						<div class="eight-banner-content">
							<div class="banner-content-box appeight-headline pera-content">
								...
								{{-- <div class="ei-banner-btn">
									<a id="shop-btn" href="/shop"><i class="fas fa-power-off"></i> Explore Now</a>
								</div> --}}
							</div>
						...
						<div class="col-lg-3 col-md-6 wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="eight-feature-box text-center position-relative">
								...
								<div class="feature-text8 appeight-headline pera-content">
									...
									<p>Committed to positively impacting the Veterinary Community and helping professionals reach New Heights Of Grown And Success.</p>
								</div>
								{{-- <a class="resource-card-btn" href="{{ route('frontend.resources.programs') }}"> Learn More </a> --}}
							</div>
						</div>
						<div class="col-lg-3 col-md-6 wow fadeFromwebsite icons update-03Up" data-wow-delay="100ms" data-wow-duration="1500ms">
							<div class="eight-feature-box text-center position-relative">
								<div class="feature-icon8 position-relative">
								...
								<div class="feature-text8 appeight-headline pera-content">
									<h3>Webinars</h3>
									<p>Earn CE Credits With Free Access To Webinars And Be Updated With Latest Veterinary Practices And Protocols.</p>
								</div>
    ...
    ============================================= -->
		...
		<!-- <section id="fun-fact" class="eg-fun-fact-section position-relative">
						...
						<div class="eg-funfact-content clearfix position-relative">
							<div class="eg-fun-fact-mockup wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
								<div class="main-mockup">
									<img src="/splash/assets/img/vet-tech/mockup/fmu1.png" alt="" />
								</div>
								<div class="fn-shape fn-shape-item1" data-parallax='{"y" : 50}'><img src="/splash/assets/img/vet-tech/mockup/fmu2.png" alt="" /></div>
								<div class="fn-shape fn-shape-item2" data-parallax='{"y" : 60}'><img src="/splash/assets/img/vet-tech/mockup/fmu3.png" alt="" /></div>
								<div class="fn-shape fn-shape-item3" data-parallax='{"x" : -50}'><img src="/splash/assets/img/vet-tech/shape/fc1.png" alt="" /></div>
								<div class="fn-shape fn-shape-item4" data-parallax='{"x" : -40}'><img src="/splash/assets/img/vet-tech/shape/fc2.png" alt="" /></div>
							</div>
			...
			<div class="fn-bg-shape position-absolute"><img src="/splash/assets/img/vet-tech/shape/fns1.png" alt="" /></div>
		</section> -->
		...
		<section id="events" class="ei-screenshots-section position-relative">
			...
			<!-- End of Connect to Science section
        ============================================= -->
		...
		<section id="seller-portal" class="eight-service-section position-relative">
			<div class="container">
				...
				<div class="eight-service-text position-relative appeight-headline wow fadeFromRight" data-wow-delay="200ms" data-wow-duration="1500ms">
					<!-- <div class="ei-service-slide-mbl" data-background="assets/img/vet-tech/291x631-Banners-04.png"> -->
		...
		<!-- Start of Connect to video player section
        ============================================= -->
		<div class="video-player-container position-fixed">
			<div class="video-player-inner-wrapper position-relative">
				...
				<div class="video-player-wrapper position-relative">
					<iframe class="video-iframe" data-src="https://player.vimeo.com/video/727050480?h=8b0760cbcf" width="640" height="564" frameborder="0" allow="autoplay; fullscreen"></iframe>
				</div>
			</div>
		</div>
		...
		<!-- Start of suppot section
        ============================================= -->
		{{-- <section id="ei-faq" class="ei-faq-section position-relative">
			<div class="container">
				<div class="eight-section-title appeight-headline pera-content text-center">
					<span class="eg-title-tag"
						>Get Premium Support 24/7 <i class="square-shape"><i></i><i></i><i></i><i></i></i
					></span>
					<h2>
						Committed To
				...
				<div class="ei-team-content">
					<div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="ei-team-img position-relative">
							<div class="team-mem-img-ei text-center position-relative">
								<img class="lazyload" data-src="/splash/assets/img/vet-tech/support/connect.svg" alt="Connect with Experts" />
							</div>
						</div>
					...
					<div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
						<div class="ei-team-img position-relative">
							<div class="team-mem-img-ei text-center position-relative">
								<img class="lazyload" data-src="/splash/assets/img/vet-tech/support/commitments.svg" alt="Commitments to Help Our Veterinarians" />
							</div>
						</div>
						<div class="ei-team-text appeight-headline text-center pera-content">
							<p>Commitments To Help Our Veterinarians</p>
						</div>
					</div>
					<div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
						<div class="ei-team-img position-relative">
							<div class="team-mem-img-ei text-center position-relative">
								<img class="lazyload" data-src="/splash/assets/img/vet-tech/support/support.svg" alt="24 / 7 Customer Support" />
							</div>
						</div>
						<div class="ei-team-text appeight-headline text-center pera-content">
			...
			<span class="ei-faq-shape fq-shape-style1" data-parallax='{"x" : 50}'><img src="/splash/assets/img/vet-tech/shape/fq-shape1.png" alt="Blob" /></span>
			<span class="ei-faq-shape fq-shape-style2"><img src="/splash/assets/img/vet-tech/shape/fq-shape2.png" alt="Blob" /></span>
			<span class="ei-faq-shape fq-shape-style3 d-none d-lg-block"><img src="/splash/assets/img/vet-tech/shape/fq-shape3.png" alt="Blob" /></span>
			<span class="ei-faq-shape fq-shape-style4 d-none d-lg-block" data-parallax='{"y" : 60}'><img src="/splash/assets/img/vet-tech/shape/fq-shape4.png" alt="Blob" /></span>
			<span class="ei-faq-shape fq-shape-style5"><img src="/splash/assets/img/vet-tech/shape/fq-shape5.png" alt="Blob" /></span>
			<span class="ei-faq-shape fq-shape-style6"><img src="/splash/assets/img/vet-tech/shape/fq-shape6.png" alt="Blob" /></span>
			...
			<span class="ei-faq-shape fq-shape-style7"
				><img src="/splash/assets/img/vet-tech/shape/fq-shape7.png" alt="Blob" /><img src="/splash/assets/img/vet-tech/shape/fq-shape7.png" alt="Blob" /> <img src="/splash/assets/img/vet-tech/shape/fq-shape7.png" alt="Blob"
			/></span>
		</section> --}}
		<!-- End of Faq section
        ============================================= -->
		...
		<script src="/splash/assets/js/script.js?v=3"></script>
	</body>
</html>
