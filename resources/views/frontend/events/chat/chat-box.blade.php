{{-- <div class="fixed bottom-0 right-0 flex flex-col items-end ml-6 w-full">
   <div class="fixed bottom-0 right-0 flex flex-col items-end ml-6 w-40">
       <div class="chat-modal show  mr-5 flex flex-col mb-5 shadow-lg">
          <!-- close button -->
          <div class="close-chat primary-bg text-white mb-1 w-10 flex justify-center items-center px-2 py-1 rounded self-end cursor-pointer">
          ...
          <div class="flex justify-between items-center text-white p-2 primary-bg border shadow-lg mr-5 w-full">
            <div class="flex items-center">
               ...
               <h2 class="font-semibold tracking-wider">{{$data['exhibitor_data']->vendor->contact_name}}</h2>
            </div>
          ...
          <!-- chats -->
      {{-- @livewire('chat')@dd($data['exhibitor_data']) --}}
      {{-- <livewire:chat :exhibitor="$data['exhibitor_data']"/> --}}
      ...
      <div class="show-chat hidden mx-10 mb-6 mt-4 text-green-500 hover:text-green-600 flex justify-center items-center cursor-pointer ">
         <svg width="4em" height="4em" viewBox="0 0 16 16" class="bi bi-chat-text-fill" fill="#4BA5DA" xmlns="http://www.w3.org/2000/svg">
