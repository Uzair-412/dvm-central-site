<x-forms.patch :action="route('frontend.user.profile.update')" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <input type="hidden" name="avatar_type" value="storage" class="form-control" />
        <label for="avatar_location" class="col-md-3 col-form-label text-md-right">@lang('Upload Profile Picture')</label>
        <div class="col-md-9">
            <input type="file" name="avatar_location" id="avatar_location" class="form-control py-3">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row mb-0">
        <div class="col-md-12 text-right">
            <button class="ps-btn float-right" type="submit">@lang('Update')</button>
        </div>
    </div><!--form-group-->
</x-forms.patch>