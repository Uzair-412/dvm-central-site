    ...
    <table class="table table-striped table-hover table-bordered mb-0">
        ...
        <tr>
            ...
            <td>
                ...
                @else
                    <img src="{{ asset('storage/'.$logged_in_user->avatar_location) }}" class="user-profile-image img-thumbnail" width="200px" />
                @endif
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th>@lang('Timezone')</th>
            <td>{{ $logged_in_user->timezone ? Str::replace('_', ' ', $logged_in_user->timezone) : __('N/A') }}</td>
        </tr>
        <tr>
