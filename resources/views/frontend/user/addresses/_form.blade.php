...
<div class="form-group form-row">
    <div class="col">
        {!! Form::label('default_billing', 'Default Billing Address:') !!}
        <br>
        <label class="radio-inline">{!! Form::radio('default_billing', 'Y', @$data['default_billing'] == 'Y' ? true : false) !!} Yes</label>
        <label class="radio-inline">{!! Form::radio('default_billing', 'N', @$data['default_billing'] == 'N' ? true : false) !!} No</label>
    </div>
    <div class="col">
