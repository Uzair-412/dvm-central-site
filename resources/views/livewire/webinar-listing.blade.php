<div class="flex flex-wrap">
    ...
    <div class="grid grid-cols-4 gap-4">
        ...
        <div class="col-span-3">
            ...
            <div class="pb-5 text-3xl"><h1>Webinars</h1></div>
            ...
            @if(count($webinars) > 0)
                ...
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                    ...
                    @foreach($webinars as $webinar)
                        <livewire:webinar-block :webinar="$webinar" :event="$event" :key="$webinar->id" />
                    @endforeach
        ...
        <div class="pt-2 text-gray-500 text-sm">Sorry, no webinars found.</div>
