<div>
    ...
    <div class="user-title text-xl md:text-2xl font-semibold pb-4 border-b border-dashed border-gray-200">Your Recent Orders</div>
        ...
        <div class="table-heading-container">
            ...
            @else
                <div class="text-center mt-2 text-blue-500">
                    <strong class="text-blue-500">Sorry!</strong>, no recent order found.
                </div>
            @endif
        </div>
    </div>
