...
<div
    ...
    class="fixed bottom-0 right-0 w-96 flex flex-col items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:justify-start space-y-4"
>
    <template x-for="(message, messageIndex) in messages" :key="messageIndex" hidden>
        ...
        >
            <div class="rounded-lg shadow-xs overflow-hidden bg-green-100">
                <div class="p-4">
