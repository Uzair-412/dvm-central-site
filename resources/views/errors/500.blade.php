   ...
   <main id="error-page" class="relative pt-20">
      <div class="error-wrapper sm-width flex flex-col relative">
         <div class="relative w-full flex flex-col">
            ...
            <h1 class="font-semibold relative text-right"><span>5</span><span>0</span><span>0</span></h1>
         </div>

         <h2 class="text-xl sm:text-3xl text-center mt-4 md:mt-6 font-semibold">OOPS! Something went wrong.</h2>
         <p class="text-gray-500 text-center leading-normal text-sm md:text-base mt-4 relative">
            We&#8217;re investigating the issue and will resolve it asap. Thanks.
         </p>
